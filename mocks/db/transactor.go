...
func (_m *Transactor) WithinTransaction(_a0 context.Context, _a1 db.TransactionHandleFunc) error {
	ret := _m.Called(_a0, _a1)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, db.TransactionHandleFunc) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
